package br.com.agendeme.notificacoes.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ConsultaNotificacaoDTO> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, ConsultaNotificacaoDTO.class.getName());
    ...
    public DefaultErrorHandler errorHandler(KafkaTemplate<String, Object> kafkaTemplate) {
        ...
        // 3 tentativas com intervalo de 2 segundos entre cada uma
