...
@Schema(description = "Dados para reativação de um paciente inativo. Nome, sexo e data de nascimento são imutáveis e não podem ser alterados. Apenas os campos informados serão atualizados.")
public record PacienteReativacaoRequest(
        ...
        @Schema(description = "Endereço do paciente. Se informado, substitui o endereço atual por completo.")
        @Valid
