...
@Schema(description = "Dados para reativação de um médico inativo. Nome, sexo, data de nascimento e especialidade são imutáveis e não podem ser alterados. Apenas os campos informados serão atualizados.")
public record MedicoReativacaoRequest(
        ...
        @Schema(description = "Endereço do médico. Se informado, substitui o endereço atual por completo.")
        @Valid
